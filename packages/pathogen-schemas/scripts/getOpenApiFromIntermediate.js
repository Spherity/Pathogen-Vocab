...
const openAPISpec = {
  openapi: '3.0.0',
  info: {
    title: 'pathogen Vocabulary Specification',
    description:
      'pathogen Schemas in OpenAPI format for use with swagger, '
    ...
    contact: {
      name: 'W3C pathogen Vocabulary',
      url: 'https://github.com/w3c-ccg/pathogen-vocab/issues',
    },
    license: {
      name: 'Apache 2.0',
